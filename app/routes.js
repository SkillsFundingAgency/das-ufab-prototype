...
// Re-direct from multiple  radios 
router.post('/sprint-2-beta/page1', function (req, res) {
    ...
    //Option 1
    if (levytype === 'Under £3 million') {
        res.redirect('/sprint-2-beta/page1b')
    }
    //Option 2
    else if (levytype === 'Over £3 million') {
        res.redirect('/sprint-2-beta/page2')
    }
...
// Re-direct from multiple  radios 
router.post('/sprint-2-beta/page3blevy', function (req, res) {
    ...
    //Option 2
        ...
        res.redirect('/sprint-2-beta/page3levy')
    }
...
// Re-direct from multiple  radios 
router.post('/sprint-2-beta/page3bnonlevy', function (req, res) {
    ...
    //Option 2
        ...
        res.redirect('/sprint-2-beta/page3nonlevy')
    }
...
// Re-direct from multiple  radios 
router.post('/sprint-2-beta/page3a', function (req, res) {
...
// Re-direct from multiple  radios 
router.post('/sprint-2-beta/page3levy', function (req, res) {
    ...
    //Option 2
        ...
        res.redirect('/sprint-2-beta/page4')
    }
...
// Re-direct from multiple  radios 
router.post('/sprint-2-beta/page3nonlevy', function (req, res) {
